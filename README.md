This repository is a small project for my interview for Fetch. It very simply pulls some data and displays it in a RecyclerView. It uses MVVM architecture, Hilt/Dagger, Room, Coroutines.
